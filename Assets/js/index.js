// Obtengo los datos del objeto 'data'
...
function imprimirCard(array) {
  ...
  if (array.length !== 0) {
    array.forEach((data) => {
      locationforCards +=`
      <div class="col-md-3 col-sm-6 col-md-4 col-lg-3">
        <div class="card">
  ...
  imprimirCard(dataOriginalEvents);


// Obtenemos las categorías de los eventos y creamos los checkboxes correspondientes
...
// Función que imprime los checkboxes
 ...
 // Listener de eventos para los checkboxes
